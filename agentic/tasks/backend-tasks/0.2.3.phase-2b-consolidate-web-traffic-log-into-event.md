# Backend Phase 2B: Consolidate WebTrafficLog into Event (Greenfield)

## Applicable Instruction Files

Standard backend set — see [`TEMPLATE_backend_task.md`](../../templates/TEMPLATE_backend_task.md).
...
| File | Note |
|------|------|
| `agentic/roadmaps/backend-marketing-server-roadmap.md` | Source of Phase 2B scope and acceptance items (§11, §12). |
