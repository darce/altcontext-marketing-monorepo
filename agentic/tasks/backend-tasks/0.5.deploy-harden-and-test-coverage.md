...
- **Deploy is live**: The Fly app is deployed (image v6) with the init migration applied, health check passing, and no Prisma in the production image. Phase 2 smoke tests and test coverage remain.
