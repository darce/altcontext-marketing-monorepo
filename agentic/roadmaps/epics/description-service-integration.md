...
Full spec: [backend-marketing-server.md](backend-marketing-server.md).
...
All marketing metrics from [backend-marketing-server.md §8](backend-marketing-server.md) remain. The new metrics are additive — they appear under `usage` and `funnel` keys in the API response, separate from `metrics` and `ingest`.
...
- Marketing backend epic: [backend-marketing-server.md](backend-marketing-server.md)
- Master roadmap: [../ROADMAP.md](../ROADMAP.md)
- Description service orchestrator: [../description-service-orchestrator.md](../description-service-orchestrator.md)
